...
class ForensicPdfGenerator(private val context: Context) {
    ...
    companion object {
        ...
        private const val APK_HASH = APKIntegrityChecker.EXPECTED_APK_HASH
    }
    ...
    private fun buildPdfContent(case: ForensicCase, narrative: String): String = buildString {
        ...
        // APK Integrity - Root of Trust
        appendLine("-".repeat(40))
        appendLine("CHAIN OF TRUST - ROOT")
        appendLine("-".repeat(40))
        appendLine("Source: Verum Omnis APK [$APK_HASH]")
        appendLine()
        appendLine("This report was generated by a cryptographically verified APK.")
        appendLine("Independent verification: sha256sum verum-omnis-forensic-engine.apk")
        appendLine("Expected hash: $APK_HASH")
        appendLine()
        ...
        appendLine("-".repeat(40))
        appendLine("APK Hash (Root of Trust): $APK_HASH")
        ...
        appendLine("-".repeat(40))
        appendLine("1. APK Integrity: $APK_HASH")
        appendLine("2. Case Created: ${dateFormatter.format(case.createdAt)}")
        case.evidenceItems.sortedBy { it.timestamp }.forEachIndexed { index, evidence ->
            appendLine("${index + 3}. ${evidence.type}: ${evidence.contentHash.take(32)}...")
        }
        appendLine()
        ...
        appendLine("- APK Root of Trust: $APK_HASH")
        appendLine()
        appendLine("INDEPENDENT VERIFICATION:")
        appendLine("sha256sum verum-omnis-forensic-engine.apk")
        appendLine("Expected output: $APK_HASH")
        appendLine()
